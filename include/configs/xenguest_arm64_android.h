...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"boot_pvblock_recovery=setenv bootargs $recovery_bootargs; pvblock read ${boot_image_addr}  0x008aa000 0x31fff; bootm ${boot_image_addr} ${boot_image_addr} ${fdt_addr};\0" \
	"boot_pvblock=run loadimage; fdt addr ${fdt_addr}; fdt get value bootargs /chosen bootargs;bootm ${boot_image_addr} - ${fdt_addr};\0"\
